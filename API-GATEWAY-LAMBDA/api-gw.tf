...
resource "aws_lambda_permission" "api_gateway" {
  ...
  source_arn = "arn:aws:execute-api:${var.myregion}:${var.accountId}:${aws_api_gateway_rest_api.canary_api.id}/*/${aws_api_gateway_method.canary_method.http_method}${aws_api_gateway_resource.canary_resource.path}"
}
# Deployment
